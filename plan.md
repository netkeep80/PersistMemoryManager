...
## Текущая фаза: Фаза 1 — Базовая структура и allocate/deallocate

Подробности по каждой фазе: [phase1.md](phase1.md)
...
| 2 | Слияние блоков (coalescing) | ⏳ Ожидает | — |
...
**Задачи:**
- [ ] Реализовать алгоритм `coalesce()` для слияния соседних свободных блоков
- [ ] Обновить `deallocate()` для вызова `coalesce()`
- [ ] Написать тесты для слияния блоков

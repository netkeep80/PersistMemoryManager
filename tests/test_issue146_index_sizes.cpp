...
TEST_CASE( "I146-B1: SmallEmbeddedStaticHeap<1024> lifecycle", "[test_issue146_index_sizes]" )
{
...
TEST_CASE( "I146-B2: SmallEmbeddedStaticHeap<1024> typed allocation", "[test_issue146_index_sizes]" )
{
    using SESH = pmm::PersistMemoryManager<pmm::SmallEmbeddedStaticConfig<1024>, 14611>;

    REQUIRE( SESH::create( 1024 ) );
...
TEST_CASE( "I146-B3: SmallEmbeddedStaticHeap<1024> no expand (StaticStorage)", "[test_issue146_index_sizes]" )
{
...
TEST_CASE( "I146-B4: SmallEmbeddedStaticHeap<1024> multiple allocations", "[test_issue146_index_sizes]" )
{
